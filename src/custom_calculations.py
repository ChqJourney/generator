...
def calculate_rated_energy_class_rating(photometric_data_table, pon, useful_luminous_flux, non_directional, mains):
    """
    计算额定能源等级评级
...
def calculate_ponmax(useful_luminous_flux, non_directional, cri, led_source, color_tuneable, mains):
    """
    计算 Ponmax (最大允许功率)
...
def calculated_zone_table(zone_0_30, zone_0_60, zone_0_90, zone_0_120, zone_0_180,beam_angel):
    """
    计算区域表格数据
    ...
    if beam_angel is not None:
        try:
            ...
            if beam_angel_value <= 30:
                ...
                return [["zone-0_30",zone_0_30],["zone-0_60",zone_0_60],["zone-0_90",zone_0_90]]
            elif beam_angel_value <= 120:
                return [["zone-0_30",zone_0_30],["zone-0_60",zone_0_60],["zone-0_90",zone_0_90],["zone-0_120",zone_0_120]]
            else:
                return [["zone-0_30",zone_0_30],["zone-0_60",zone_0_60],["zone-0_90",zone_0_90],["zone-0_120",zone_0_120],["zone-180", zone_0_180]]
        except ValueError:
            pass
